...
export async function GET() {
  ...
  await prisma.gcsDaily.upsert({
    where: { ts: rec.ts },
    update: {
      gcs: rec.gcs, regime: rec.regime, recommendation: rec.recommendation,
      confidence: rec.confidence, explanation: rec.breakdown as any
    },
    create: {
      ts: rec.ts, gcs: rec.gcs, regime: rec.regime, recommendation: rec.recommendation,
      confidence: rec.confidence, explanation: rec.breakdown as any
    }
  });
